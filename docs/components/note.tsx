...
export default function Note({ children, variant = "note" }: NoteProps) {
  const styles = {
    ...
    important: {
      border: "border-l-4 border-purple-500 dark:border-purple-600",
  ...
  return (
    <div
      className={`my-6 px-4 pt-4 pb-1 ${style.border} ${style.bg} rounded-md text-gray-700 dark:text-gray-200`}
    >
      <div
