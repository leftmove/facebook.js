...
export default function GlobalError({
  ...
  return (
    <html lang="en">
      <body>
        <div
          className="flex flex-col items-center justify-center min-h-screen text-center px-4 bg-white dark:bg-gray-950"
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-md">
            We&apos;re sorry, but there was a critical error. Our team has been
            notified.
          </p>
